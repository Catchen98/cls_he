...
from .layers.pooling import GeM,GlobalConcatPool2d,GlobalAttnPool2d,GlobalAvgAttnPool2d,GlobalMaxAttnPool2d,GlobalConcatAttnPool2d,GlobalAvgMaxPool2d, AdaptiveGeM2d
from .layers.cosine_loss import AdaCos,ArcFace,SphereFace,CosFace,ArcCos,CircleSoftmax, ArcSoftmax
...
class CosineBaseline(nn.Module):
    ...
    def __init__(self, num_classes, last_stride, model_path, backbone="resnet50", pool_type='avg', use_dropout=False,cosine_loss_type='',s=30.0,m=0.35,use_bnbias=False,use_sestn=False):
