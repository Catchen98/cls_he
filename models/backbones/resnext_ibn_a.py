...
__all__ = ['ResNeXt_IBN', 'resnext50_ibn_a', 'resnext101_ibn_a', 'resnext152_ibn_a']
...
def resnext50_ibn_a(last_stride, baseWidth=4, cardinality=32):
    """
    Construct ResNeXt-50.
    """
    model = ResNeXt_IBN(last_stride, baseWidth, cardinality, [3, 4, 6, 3], 1000)
    return model
...
def resnext101_ibn_a(last_stride, baseWidth=4, cardinality=32):
    ...
    """
    model = ResNeXt_IBN(last_stride, baseWidth, cardinality, [3, 4, 23, 3], 1000)
    return model

def resnext152_ibn_a(last_stride, baseWidth=4, cardinality=32):
    """
    Construct ResNeXt-152.
    """
    model = ResNeXt_IBN(last_stride, baseWidth, cardinality, [3, 8, 36, 3], 1000)
    return model