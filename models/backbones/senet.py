...
def senet154(last_stride, pretrained='imagenet'):
    model = SENet(SEBottleneck, [3, 8, 36, 3], groups=64, reduction=16,
                  dropout_p=0.2, last_stride=last_stride)
...
def se_resnet50(last_stride, pretrained='imagenet'):
...
def se_resnet101(last_stride, pretrained='imagenet'):
...
def se_resnet152(last_stride, pretrained='imagenet'):
...
def se_resnext101_32x4d(last_stride, pretrained='imagenet'):
