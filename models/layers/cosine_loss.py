...
class HardMiningArcFace(nn.Module):
...
class CosFace(nn.Module):
    ...
    def __repr__(self):
        return self.__class__.__name__ +\
               ...
               ', ' + 'm=' + str(self.m) +\
               ')'
# https://github.com/Xiangyu-CAS/AICity2020-VOC-ReID/blob/master/lib/layers/metric_learning.py
class CircleSoftmax(nn.Module):
    ...
    def __call__(self, bn_feat, targets=None):
...
# https://github.com/JDAI-CV/fast-reid/blob/master/fastreid/layers/arc_softmax.py
